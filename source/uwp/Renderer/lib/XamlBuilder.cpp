...
namespace AdaptiveCards { namespace XamlCardRenderer
{
        ...
        bool isHorizontal)
    {
        ...
        Color lineColor;
        if (S_OK == separationOptions->get_LineColor(&lineColor))
        {
        ...
        IUIElement** columnSetControl)
    {
        ...
        XamlHelpers::IterateOverVector<IAdaptiveColumn>(columns.Get(), [this, xamlGrid, gridStatics, &currentColumn, &currentColumnDefinition](IAdaptiveColumn* column)
        {
            ...
            if (separation != ABI::AdaptiveCards::XamlCardRenderer::SeparationStyle::None)
            {
                ...
                if (separationOptions != nullptr)
                {
                    ...
                    ComPtr<IFrameworkElement> separatorAsFrameworkElement;
                    THROW_IF_FAILED(separator.As(&separatorAsFrameworkElement));
                    gridStatics->SetColumn(separatorAsFrameworkElement.Get(), currentColumnDefinition++);
            ...
            gridStatics->SetColumn(columnAsFrameworkElement.Get(), currentColumnDefinition++);
